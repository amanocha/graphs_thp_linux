...
//ANINDA: adding do_sync_promote and split_huge_pages_pid so that it is accessible by madvise
static inline unsigned int
do_sync_promote(struct mm_struct *mm, unsigned long vaddr_start, unsigned long vaddr_end)
{
	return 0;
}
